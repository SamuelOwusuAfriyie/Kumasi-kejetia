...
this.props.fetchItemLogin(this.state)
  ...
  handleSubmit(e) {
    ...
    ()=>(this.props.history.push(`/SellOptions/${this.props.logger[0]._id}`))
    )
    }
  }
...
if(this.props.auth === 'authorized'){
  ...
  return (<LoginForm {...this.state} handleChange={this.handleChange} handleSubmit={this.handleSubmit}/>)
}
  }
}
...
export default connect(mapStateToProps,{fetchItemLogin, setCookies})(withRouter(LoginContainer));
