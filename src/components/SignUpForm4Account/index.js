...
import SignUpForm4Account from "./SignUpForm4Account.js";
import {addItem} from "./../../actions/index.js";
import {connect} from "react-redux";

class SignUpForm4AccountContainer extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      firstName: "",
  ...
  handleSubmit(e) {
    ...
    if(this.state.password !== this.state.confirmPassword){
      ...
      this.props.history.push(`/ConfirmEmail4MyAccount/${this.state.email}`);
  ...
  render() {
    return(
      <div>
      <SignUpForm4Account {...this.state} onChange={this.handleChange} handleSubmit={this.handleSubmit}/>
    </div>
    )
  }
}
...
export default connect(null,{addItem})(SignUpForm4AccountContainer);
