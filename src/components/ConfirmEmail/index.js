...
// }
  ...
  handleSubmit(e){
    ...
    if(this.state.confirmCode === this.props.logger.id){
      ...
      this.props.history.push(`/SellOptions/${this.props.logger._id}`);
    }else {
  ...
  render() {
    ...
    return(
      <div>
        <ConfirmEmail {...this.state} handleSubmit={this.handleSubmit} handleChange={this.handleChange}/>
      </div>
    )
  }
}
...
export default connect(mapStateToProps,{fetchItem, fetchItemAndUpdate})(ConfirmEmailContainer);
